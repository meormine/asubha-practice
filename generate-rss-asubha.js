...
const itemsXml = history.map(item => `
    <item>
      ...
      <link>${item.url || 'https://meormine.github.io/asubha-practice'}</link>
      <description><![CDATA[
...
<rss version="2.0">
  <channel>
    ...
    <link>https://meormine.github.io/asubha-practice</link>
    <description>Asubha Practice</description>
    <lastBuildDate>${pubDate}</lastBuildDate>
    <image>
      <url>https://meormine.github.io/asubha-practice/favicon.ico</url>
      <title>Asubha Practice</title>
      <link>https://meormine.github.io/asubha-practice/favicon.ico</link>
    </image>
    ${itemsXml}
  </channel>
</rss>`;
